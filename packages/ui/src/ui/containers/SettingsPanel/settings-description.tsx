...
import generalIcon from '../../../../img/svg/tools-icon.svg';
import paletteIcon from '../../../../img/svg/palette-icon.svg';
import closeTagIcon from '../../../../img/svg/close-tag-icon.svg';
import dataIcon from '../../../../img/svg/data-icon.svg';
...
import componentsIcon from '../../../../img/svg/page-components.svg';
